...
class AsyncParametresEclairageControlleurRecupererDonnees constructor(var parametreEclairage: ParametreEclairage, var whiteTime: EditText, var blueTime : EditText, var errParamTemp: TextView, var context: Context){
    ...
    private fun lierViewAvecParametresTemperature(parametreEclairage: ParametreEclairage) {
        whiteTime!!.setText(parametreEclairage.recupererHeuresEtMinutes(parametreEclairage.whiteTime).toString())
        blueTime!!.setText(parametreEclairage.recupererHeuresEtMinutes(parametreEclairage.blueTime).toString())
    }
}